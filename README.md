...
해외여행 중 **지금 필요한 행동**을 빠르게 실행할 수 있도록 돕는 로그인 없는 Galaxy 전용 모바일 앱입니다. 첫 지원 국가는 일본입니다.
...
- 탐색: 실제 지도, 맛집·카페·관광·쇼핑 필터, 지역 선택, Google Maps 길찾기
...
- `Verify TripNow`: push와 PR에서 TypeScript, Expo 의존성, Android JS 번들을 검사
